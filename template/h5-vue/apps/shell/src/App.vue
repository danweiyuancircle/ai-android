...
import { useFocusManager } from '@shell/core'
import { createRouteCacheManager } from '@shell/core'
import { useAutoBackButton } from '@shell/core'
import { useVoiceInteraction } from '@shell/core'
import { setNavigateToAIChatCallback } from '@shell/core'
import { navigateToAIChat } from '@shell/core'
import { VoiceDialog } from '@shell/ui'
import { ExitDialog } from '@shell/ui'
